...
function EditarUsuario(props) {
    const [state, setState] = useState({
        image: props.location.state.image ? props.location.state.image : "",
        nombre: props.location.state.image.nombre
            ? props.location.state.image.nombre
            : "",
        fecha: props.location.state.image.fecha
            ? props.location.state.image.fecha
            : "",
        descripcion: props.location.state.image.descripcion
            ? props.location.state.image.descripcion
            : "",
        imagen: props.location.state.image.imagen
            ? props.location.state.image.imagen
            : "",
        srcPrevImg: "/assets/img/galery/" + props.location.state.image.imagen,
        loading: false,
    ...
    useEffect(() => {
        document.title = "Editar Imagen";

        props.setActiveComponentProp("EditarImagen");
    }, []);
    ...
    const onSubmitHandle = (e) => {
        ...
        if (simpleValidator.current.allValid()) {
            ...
            axios
                .post("/api/v1/galeria/actualizar", $(e.target).serialize())
                .then((response) => {
                    setState({
                        ...state,
                        loading: false,
