...
const ListarSugerencia = (props) => {
    ...
    const loadData = () => {
        setIsLoading(true);
        axios
            .get("/api/v1/sugerencias/listar?page=" + state.currentPage, {
                params: {
            ...
            .then((response) => {
                setIsLoading(false);
                setSugerencias(response.data.message.data);
                setState({
                    ...state,
                    ...
                    arraySuge: response.data.message.data,
                });
            })
            .catch((error) => {
                showSznNotification({
            ...
            buttons: [
                {
                    ...
                    onClick: () => {
                        ...
                        axios
                            .post("/api/v1/sugerencias/eliminar", {
                                api_token: authUser.api_token,
                                id: id,
                            })
                            .then((response) => {
    ...
    const print = () => {
        var columns = [
            ...
            { title: "Descripcion", dataKey: "sugerencia" },
            { title: "Enviada por", dataKey: 'nombre' },
        ];
        ...
        doc.text(" Reporte de solicitudes", 50, 68);
        ...
        doc.autoTable(columns, state.arraySuge, {
            theme: "grid",
    ...
    const exportExcelFile = () => {
        ...
        const sheet = workbook.addWorksheet("Reporte_Sugerencias");
        ...
        sheet.addRow({
            fec: sug.fecha,
            desc: sug.sugerencia,
            envX: sug.nombre + ' ' + sug.primerApellido + ' ' + sug.segundoApellido
        })
       })
        ...
        workbook.xlsx.writeBuffer().then(doc =>{
            ...
            anchor.href = url;
            anchor.download = "Reporte_Sugerencias.xlsx";
            anchor.click();
...
export default connect(mapStateToProps, mapDispatchToProps)(ListarSugerencia);
