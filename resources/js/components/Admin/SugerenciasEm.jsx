...
import NuevaSugerencia from "../Admin/Sugerencias/NuevaSugerencia";
import ListarSugerenciaEm from "../Admin/Sugerencias/ListarSugerenciaEm";
            ...
            <React.Fragment>
                ...
                <h3 className="page-title">
                            ...
                            <span className="page-title-icon bg-gradient-light text-dark mr-2">
                                {activeComponent &&
                                activeComponent == "ListarSugerenciaEm" ? (
                            ...
                            {activeComponent && activeComponent == "ListarSugerenciaEm"
                                ? (`Sugerencias enviadas por ${authUser.nombre}`
                                ): 
                                 ("Nueva sugerencia")}
                        </h3>
                ...
                <div className="container-fluid p-1">
                        <div className="row">
                            ...
                            <Switch>
                                <Route exact path="/sugerenciasEm/listar">
                                ...
                                <Route exact path="/sugerencias/store">
