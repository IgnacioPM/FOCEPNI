...
function VerSolicitud(props) {
    ...
    useEffect(() => {
        ...
        props.setActiveComponentProp("GestionSolicitud");
    }, []);
            ...
            buttons: [
                {
                    ...
                    onClick: () => {
                        ...
                        axios
                            .post("/api/v1/emprendimiento/accept", {
                                api_token: authUser.api_token,
                                id: id,
                                Observacion: state.ObservacionEmp,
                            })
                            .then((response) => {
                                setIsLoading(false);
            ...
            buttons: [
                {
                    ...
                    onClick: () => {
                        ...
                        //ruta de la api en webapi
                        axios
                            .post("/api/v1/emprendimiento/deny", {
                                api_token: authUser.api_token,
                                id: id,
                                Observacion: state.ObservacionEmp,
                            })
                ...
                <div className="col-lg-12 col-md-12 col-xs-6">
                    <div className="row">
                        ...
                        <div className="shadow row p-3 mt-4">
                            ...
                            <div className="form-group col-md-12 col-xs-6 m-0 mt-5 mb-5">
