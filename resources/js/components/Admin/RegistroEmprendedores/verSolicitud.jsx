...
import TopControlEmp from "./TopControlEmp";
...
const verSolicitudes = (props) => {
    ...
    useEffect(() => {
        ...
        props.setActiveComponentProp("VerSolicitud");
    }, []);
    ...
    const loadData = () => {
        setIsLoading(true);
        axios
            .get("/api/v1/emprendimiento/listar?page=" + state.currentPage, {
                params: {
    ...
    const print = () => {
        ...
        doc.text(" Reporte de solicitudes emprendimiento", 50, 68);
        ...
        doc.save("Reporte_solicitudes_Emprendimiento.pdf");
    };

    const exportExcelFile = () => {
        const workbook = new ExcelJS.Workbook();
        const sheet = workbook.addWorksheet("Solicitud_Emprendimiento");
       ...
       solicitud.map(soli => {
        ...
        workbook.xlsx.writeBuffer().then(users =>{
            ...
            anchor.href = url;
            anchor.download = "Solicitud_Emprendimiento.xlsx";
            anchor.click();
