...
function NuevaNoticia(props){
    ...
    useEffect(() => {
        document.title = "Agregar nueva Noticia";

        props.setActiveComponentProp("NuevaNoticia");
    }, []);
    ...
    const onSubmitHandle = (e) => {
        ...
        if (simpleValidator.current.allValid()) {
            ...
            axios.post("/api/v1/noticias/guardar", $(e.target).serialize())
                .then((response) => {
                    setState({
                        ...state,
                        loading: false,
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="input-group input-group-sm">
                                            ...
                                            required
                                                ...
                                                id="ubicacion"
                                                name="ubicacion"
                                                placeholder="Ubicación/Lugar a realizar"
...
export default connect(mapStateToProps, mapDispatchToProps)(NuevaNoticia);
