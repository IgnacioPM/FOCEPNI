...
import UsuarioItem from "./UsuarioItemGeo";
import Pagination from "react-js-pagination";
import { useSelector, connect } from "react-redux";
import rootAction from "../../../redux/actions/index";
import ContentLoader from "react-content-loader";
import { showSznNotification } from "../../../Helpers";
import TopControl from "./TopControlGeo";
...
function UserList(props) {
    ...
    useEffect(() => {
        ...
        props.setActiveComponentProp("Listar");
    }, []);
    ...
    const loadData = () => {
        setIsLoading(true);
        axios
            .get("/api/v1/usuario/listDataGeo?page=" + state.currentPage, {
                params: {
    ...
    const onClickDeleteHandler = (id) => {
        confirmAlert({
            title: "Desea eliminar la georreferencia del usuario",
            message: "esta seguro?",
            buttons: [
                {
                    label: "Si",
                    onClick: () => {
                        ...
                        //ruta de la api en webapi
                        axios
                            .post("/api/v1/empredimiento/delGeo", {
                                api_token: authUser.api_token,
                                idE: id,
                            })
                            .then((response) => {
    ...
    const exportExcelFile = () => {
        ...
        const sheet = workbook.addWorksheet("Georreferencia_Usuarios");
       ...
       users.map(users => {
        sheet.addRow({
            ...
            email: users.email,
            latitud: users.latitud == null ? "Sin registrar" : users.latitud,
            longitud: users.longitud == null ? "Sin registrar" : users.longitud,
        ...
        workbook.xlsx.writeBuffer().then(users =>{
            ...
            anchor.href = url;
            anchor.download = "Geolocalizacion.xlsx";
            anchor.click();
                ...
                <div className="container">
                    <div className="card text-center text-danger">
                        <div className="card-body">
                            <h1>Usuario bloqueado, no puede ingresar</h1>
                        </div>
                    </div>
                </div>
            </React.Fragment>
