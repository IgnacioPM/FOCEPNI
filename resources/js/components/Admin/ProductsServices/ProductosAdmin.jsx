...
import SolicitudItem from "./ProductItemAll";
import TopControl from "./TopControlAll";
...
const verSolicitudesProducts = (props) => {
    ...
    useEffect(() => {
        ...
        props.setActiveComponentProp("ProductsAdmin");
    }, []);
    ...
    const loadData = () => {
        setIsLoading(true);
        axios
            .get("/api/v1/productsEm/ver?page=" + state.currentPage, {
                params: {
    ...
    const print = () => {
        ...
        doc.text(" Reporte de Productos", 50, 68);
    ...
    const exportExcelFile = () => {
        ...
        const sheet = workbook.addWorksheet("Reporte_Productos");
        ...
        workbook.xlsx.writeBuffer().then(prod =>{
            ...
            anchor.href = url;
            anchor.download = "Reporte_Productos.xlsx";
            anchor.click();
